...
/**
 * NYTimesLDCDocument <BR> Created: Jun 17, 2008 <BR> Author: Evan Sandhaus (sandhes@nytimes.com)<BR> <P> This class represents a New York
 * Times Corpus Document. See field comments for individual field description. <P>
 *
...
public class NYTCorpusDocument implements Serializable {
   ...
   * published on or after April 02, 2006, as the linked page will have richer content.
   */
  ...
  /**
   * This field specifies the biography of the author of the article. Generally, this field is specified for guest authors not for New York
   * Times reporters. When this field is specified for Times reporters, it is usually used to provide the author's email address.
   */
  protected String authorBiography;

  /**
   * The banner field is used to indicate if there has been additional information appended to the articles since its publication. Examples
   * of banners include ('Correction Appended' and 'Editor's Note Appended').
   */
  protected String banner;

  /**
   * When present, the biographical category field generally indicates that a document focuses on a particular individual. The value of the
   * field indicates the area or category in which this individual is best known. This field is most often defined for Obituaries and Book
   * Reviews. These tags are hand-assigned by a team of library scientists working for the New York Times Indexing service.
   *
   * <ol> <li>Politics and Government (U.S.) <li>Books and Magazines <li>Royalty </ol>
   */
  ...
  /**
   * This field specifies the byline of the article as it appeared in the print edition of the New York Times. Please note that not every
   * article in this collection has a byline, as editorials and other types of articles are generally unsigned. <P> Sample byline: <ul>
   * <li>By James Reston <li>By JAMES GLANZ; William J. Broad contributed reporting for this article. <li>By ADAM NAGOURNEY and JEFF ZELENY
   * </ul>
   */
  protected String byline;

  /**
   * If the article is part of a regular column, this field specifies the name of that column. <p> Sample Column Names: <p> <ol> <li>World
   * News Briefs <li>WEDDINGS <li>The Accessories Channel </ol>
   */
  protected String columnName;

  /**
   * This field specifies the column in which the article starts in the print paper. A typical printed page in the paper has six columns
   * numbered from right to left. As a consequence most, but not all, of the values for this field fall in the range 1-6.
   */
  protected Integer columnNumber;

  /**
   * This field specifies the date on which a correction was made to the article. Generally, if the correction date is specified, the
   * correction text will also be specified (and vice versa).
   */
  protected Date correctionDate;

  /**
   * For articles corrected following publication, this field specifies the correction. Generally, if the correction text is specified, the
   * correction date will also be specified (and vice versa).
   */
  protected String correctionText;

  /**
   * This field indicates the entity that produced the editorial content of this document. For this collection, the credit will always be
   * set to 'The New York Times'.
   */
  protected String credit;

  /**
   * The ÔdatelineÕ field is the dateline of the article. Generally a dateline is the name of the geographic location from which the article
   * was filed followed by a comma and the month and day of the filing. <p> Sample datelines: <ul> <li>WASHINGTON, April 30 <li>RIYADH,
   * Saudi Arabia, March 29 <li>ONTARIO, N.Y., Jan. 26 </ul> Please note: <ol> <li>The dateline location is the location from which the
   * article was filed. Often times this location is related to the content of the article, but this is not guaranteed. <li>The date
   * specified for the dateline is often but not always the day previous to the publication date. <li>The date is usually but not always
   * specified. </ol>
   */
  protected String dateline;

  /**
   * This field specifies the day of week on which the article was published. <ul> <li>Monday <li>Tuesday <li>Wednesday <li>Thursday
   * <li>Friday <li>Saturday <li>Sunday </ul>
   */
  protected String dayOfWeek;

  /**
   * The ÔdescriptorsÕ field specifies a list of descriptive terms drawn from a normalized controlled vocabulary corresponding to subjects
   * mentioned in the article. These tags are hand-assigned by a team of library scientists working in the New York Times Indexing service.
   * <p> Examples Include: <ol> <li>ECONOMIC CONDITIONS AND TRENDS <li>AIRPLANES <li>VIOLINS </ol>
   */
  ...
  /**
   * The Ôgeneral online descriptorsÕ field specifies a list of descriptors that are at a higher level of generality than the other tags
   * associated with the article. These tags are algorithmically assigned and manually verified by nytimes.com production staff. <p>
   * Examples Include: <ol> <li>Surfing <li>Venice Biennale <li>Ranches </ol>
   */
  ...
  /**
   * The Ôlead ParagraphÕ field is the lead paragraph of the article. Generally this field is populated with the first two paragraphs from
   * the article.
   */
  protected String leadParagraph;

  /**
   * The ÔlocationsÕ field specifies a list of geographic descriptors drawn from a normalized controlled vocabulary that correspond to
   * places mentioned in the article. These tags are hand-assigned by a team of library scientists working for the New York Times Indexing
   * service. <p> Examples Include: <ol> <li>Wellsboro (Pa) <li>Kansas City (Kan) <li>Park Slope (NYC) </ol>
   */
  protected List<String> locations = new ArrayList<String>();

  /**
   * The ÔnamesÕ field specifies a list of names mentioned in the article. These tags are hand-assigned by a team of library scientists
   * working for the New York Times Indexing service. <p> Examples Include: <ol> <li>Azza Fahmy <li>George C. Izenour <li>Chris Schenkel
   * </ol>
   */
  protected List<String> names = new ArrayList<String>();

  /**
   * This field specifies the desk in the New York Times newsroom that produced the article. The desk is related to, but is not the same as
   * the section in which the article appears.
   */
   ...
   * These tags are algorithmically assigned and manually verified by nytimes.com production staff. <p> Examples Include: <ol> <li>Marriages
   * <li>Parks and Other Recreation Areas <li>Cooking and Cookbooks </ol>
   */
  ...
  /**
   * This field specifies a list of place names that correspond to geographic locations mentioned in the article. These tags are
   * algorithmically assigned and manually verified by nytimes.com production staff. <p> Examples Include: <ol> <li>Hollywood <li>Los
   * Angeles <li>Arcadia </ol>
   */
  protected List<String> onlineLocations = new ArrayList<String>();

  /**
   * This field specifies a list of organizations that correspond to organizations mentioned in the article. These tags are algorithmically
   * assigned and manually verified by nytimes.com production staff. <p> Examples Include: <ol> <li>Nintendo Company Limited <li>Yeshiva
   * University <li>Rose Center </ol>
   */
  protected List<String> onlineOrganizations = new ArrayList<String>();

  /**
   * This field specifies a list of people that correspond to individuals mentioned in the article. These tags are algorithmically assigned
   * and manually verified by nytimes.com production staff. <p> Examples Include: <ol> <li>Lopez, Jennifer <li>Joyce, James <li>Robinson,
   * Jackie </ol>
   */
  protected List<String> onlinePeople = new ArrayList<String>();

  /**
   * This field specifies the section(s) on nytimes.com in which the article is placed. If the article is placed in multiple sections, this
   * field will be specified as a Ô;Õ delineated list.
   */
  protected String onlineSection;

  /**
   * This field specifies a list of authored works mentioned in the article. These tags are algorithmically assigned and manually verified
   * by nytimes.com production staff. <p> Examples Include: <ol> <li>Matchstick Men (Movie) <li>Blades of Glory (Movie) <li>Bridge & Tunnel
   * (Play) </ol>
   */
  protected List<String> onlineTitles = new ArrayList<String>();

  /**
   * This field specifies a list of organization names drawn from a normalized controlled vocabulary that correspond to organizations
   * mentioned in the article. These tags are hand-assigned by a team of library scientists working in the New York Times Indexing service.
   * <p> Examples Include: <ol> <li>Circuit City Stores Inc <li>Delaware County Community College (Pa) <li>CONNECTICUT GRAND OPERA </ol>
   */
  protected List<String> organizations = new ArrayList<String>();

  /**
   * This field specifies the page of the section in the paper in which the article appears. This is not an absolute pagination. An article
   * that appears on page 3 in section A occurs in the physical paper before an article that occurs on page 1 of section F.
   */
   ...
   * These tags are hand-assigned by a team of library scientists working in the New York Times Indexing service. <p> Examples Include: <ol>
   * <li>REAGAN, RONALD WILSON (PRES) <li>BEGIN, MENACHEM (PRIME MIN) <li>COLLINS, GLENN </ol>
   */
  ...
  /**
   * This field specifies the section of the paper in which the article appears. This is not the name of the section, but rather a letter or
  ...
  /**
   * The slug is a short string that uniquely identifies an article from all other articles published on the same day. Please note, however,
   * that different articles on different days may have the same slug. <ul> <li>30other <li>12reunion </ul>
   */
  ...
  /**
   * This field specifies a list of taxonomic classifiers that place this article into a hierarchy of articles. The individual terms of each
   * taxonomic classifier are separated with the '/' character. These tags are algorithmically assigned and manually verified by nytimes.com
   * production staff. These tags are algorithmically assigned and manually verified by nytimes.com production staff. <p> Examples Include:
   * <ol> <li>Top/Features/Travel/Guides/Destinations/North America/United States/Arizona <li>Top/News/U.S./Rockies <li>Top/Opinion </ol>
   */
  protected List<String> taxonomicClassifiers = new ArrayList<String>();

  /**
   * This field specifies a list of authored works that correspond to works mentioned in the article. These tags are hand-assigned by a team
   * of library scientists working in the New York Times Indexing service. <p> Examples Include: <ol> <li>Greystoke: The Legend of Tarzan,
   * Lord of the Apes (Movie) <li>Law & Order (TV Program) <li>BATTLEFIELD EARTH (BOOK) </ol>
   */
  protected List<String> titles = new ArrayList<String>();

  /**
   * This field specifies a normalized list of terms describing the general editorial category of the article. These tags are
   * algorithmically assigned and manually verified by nytimes.com production staff. <p> Examples Include: <ol> <li>REVIEW <li>OBITUARY
   * <li>ANALYSIS </ol>
   */
  protected List<String> typesOfMaterial = new ArrayList<String>();

  /**
   * This field specifies the location on nytimes.com of the article. The ÔAlternative UrlÕ field is preferred to this field on articles
   * published on or after April 02, 2006, as the linked page will have richer content.
   */
  protected URL url;
  ...
  /**
   * Left justify a string by forcing it to be the specified length. This is done by concatonating space characters to the end of the string
   * until the string is of the specified length. If, however, the string is initially longer than the specified length then the original
   * string is returned.
   *
   * @param s      A string.
